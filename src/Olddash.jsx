...
const smallWeatherImages = {
  "Mostly Sunny": "./mostlysunny_small.png",
    ...
    <div className="dashboard-container">
      ...
      {weather && (
        <div className="section current-weather" style={{ textAlign: 'left' }}>
          <img src={getWeatherImage(weather.weather)} alt={weather.weather} style={{ width: '130px', height: '130px', margin: '-10px 0' }} />
          <p style={{ fontSize: '58px', fontWeight: 'normal', color: 'white', margin: '-10px 0 0px 5px' }}>{weather.temperature}°F</p>
          <p style={{ fontSize: '14px', fontWeight: '100', color: 'white', margin: '-15px 0 0 15px' }}>Feels like: {weather.heatIndex}°F</p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', margin: '-20px 0 15px -5px' }}>
            ...
            <p style={{ fontSize: '18px', fontWeight: 'normal', color: 'white', margin: '30px 0' }}>{weather.weather}</p>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', margin: '-10px 0 5px -5px' }}>
            ...
            <p style={{ fontSize: '16px', margin: '0' }}>{location}</p>
          </div>
